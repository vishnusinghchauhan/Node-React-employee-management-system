	                      ...
	                      <Form role="form" onSubmit={this.submitValue}>
	                        ...
	                        <FormGroup>
	                          <InputGroup className="input-group-alternative mb-3">
	                            ...
	                            <Input className="form-control-alternative" placeholder="Name" type="text" defaultValue={this.state.name}  onChange={e => this.setState({ name: e.target.value })}  />
	                          </InputGroup>
	                        </FormGroup>
	                        ...
	                        <FormGroup >
	                          <InputGroup className="input-group-alternative mb-3">
	                            ...
	                            <Input className="form-control-alternative" placeholder="Email" type="email" defaultValue={this.state.email}  onChange={e => this.setState({ email: e.target.value })}  />
	                          </InputGroup>
	                        </FormGroup>
